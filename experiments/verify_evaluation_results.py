"""Check numerical accounting, feasibility, and validation-selection records."""
...
def main():
    ...
    for path in daily_paths:
        ...
        if path.name.startswith(('learned_daily_', 'selected_daily_', 'comparative_reference_daily')):
    ...
    selections = list((ROOT / 'checkpoints').glob('study_*/confirmatory/*/seed*/validation_selection.json'))
    ...
    for fee, seeds in [(20, 5), (40, 25), (80, 5)]:
        frame = read_aligned_parquet(results / f'learned_daily_study_winter_fee{fee}.parquet')
