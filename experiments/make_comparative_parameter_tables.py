...
OUT = ROOT / "manuscript" / "generated" / "comparative_parameter_tables.tex"
...
def main() -> int:
    ...
    scale_lookup = {}
    tag_lookup = {
        ("winter", 20): ("study_winter_fee20", "winter_weekday"),
        ("winter", 40): ("study_winter_fee40", "winter_weekday"),
        ("winter", 80): ("study_winter_fee80", "winter_weekday"),
        ("spring", 40): ("study_spring_fee40", "spring_weekday"),
        ("summer", 40): ("study_summer_fee40", "summer_weekday"),
        ("autumn", 40): ("study_autumn_fee40", "autumn_weekday"),
    }
