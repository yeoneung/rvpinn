...
Run-Cell -Tag 'study_winter_fee20' -Regime 'winter_weekday' -Fee 20 -Seeds (0..4)
Run-Cell -Tag 'study_winter_fee40' -Regime 'winter_weekday' -Fee 40 -Seeds (0..24)
Run-Cell -Tag 'study_winter_fee80' -Regime 'winter_weekday' -Fee 80 -Seeds (0..4)
...
Run-Cell -Tag 'study_spring_fee40' -Regime 'spring_weekday' -Fee 40 -Seeds (0..4)
Run-Cell -Tag 'study_summer_fee40' -Regime 'summer_weekday' -Fee 40 -Seeds (0..4)
Run-Cell -Tag 'study_autumn_fee40' -Regime 'autumn_weekday' -Fee 40 -Seeds (0..4)
