"""Run comparators under one objective and 15-minute update rule."""
...
def main() -> int:
    ...
    if any(row.get("deployment_version") != DEPLOYMENT_VERSION
        ...
        raise RuntimeError("incompatible outputs cannot be resumed with this deployment configuration; "
