...
@pytest.mark.parametrize('tag,expected', [
    ('study_winter_fee80', (300, 80, 10)),
    ('study_summer_fee40', (300, 40, 10)),
    ('study_sens_t250_f20_w5', (250, 20, 5)),
])
...
def test_tariff_and_solver_budget_metadata_are_not_inferred_from_filename():
    ...
    name = 'common_daily_confirmatory_thr300_fee40_w10_n8_nested_stream7301_pool16_tl5.parquet'
...
def selection_example(tmp_path, monkeypatch, params, fallback=False):
    tag, regime = 'study_winter_fee40', 'winter_weekday'
